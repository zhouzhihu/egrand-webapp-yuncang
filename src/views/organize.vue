<template>
  <el-container class="organize">
    ...
    <el-container>
      <el-aside style="background-color: #fcfcfc;border-right: 1px solid #ededed;width: 190px;">
      ...
      <el-container>
        <el-main style="padding:0px">
                  ...
                  <el-tab-pane>
                    ...
                    <div style="padding:12px;">
                      ...
                      <el-row :gutter="20" style="font-size:16px;">
                        <el-col :span="6" style="color:#409eff;"><i class="fa fa-folder" style="margin-right:5px;"></i>廉政工作(92)</el-col>
          ...
          <el-container>
            <el-aside style="background-color: #fcfcfc;border-right: 1px solid #ededed;width: 210px;">
              <el-main style="padding:0px">
                <el-tree
                  class="filter-tree"
                  :data="data1"
